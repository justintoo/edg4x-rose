 ...
 *---------------------------------------------------------------------------*/
std::list<std::string> Rose::Cmdline::Fortran::OpenFortranParser::jvm_options;
...
std::string
Rose::Cmdline::Fortran::OpenFortranParser::
GetRoseClasspath ()
{
...
StripRoseOptions (std::vector<std::string>& argv)
{
  ...
  BOOST_FOREACH(std::string java_option, java_options)
  {
...
// #if ROSE_INTERNAL_DEBUG
  ...
  // TOO1 (2/140/2014): Refactor into Rose::Cmdline::Java namespace
  // DQ (10/12/2010): Added support for Java
     Rose::Cmdline::Java::StripRoseOptions(argv);
     optionCount = sla(argv, "-rose:", "($)", "(relax_syntax_check)",1);
